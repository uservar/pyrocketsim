...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        cmake_args = [
            ...
            f"-DBOOST_ROOT={boost_root}" if boost_root else ""
        ]
        ...
        build_dir = (Path(ext.sourcedir) / "build").resolve()
        ...
        subprocess.run(
            ["cmake", "-B", build_dir, *cmake_args], cwd=ext.sourcedir, check=True
        )
        subprocess.run(
            ["cmake", "--build", build_dir, *build_args], cwd=ext.sourcedir, check=True
        )
